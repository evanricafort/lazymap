...
declare -A scripts=(
    ["SMB Security"]='nmap -p 139,445 --script smb-security-mode,smb2-security-mode,smb-enum-users.nse,smb-vuln-cve2009-3103,smb-vuln-ms06-025,smb-vuln-ms07-029,smb-vuln-ms08-067,smb-vuln-ms10-054,smb-vuln-ms10-061,smb-vuln-ms17-010 -oN results/smbsec.txt -v'
    ["SSL Cipher"]='nmap --script ssl-enum-ciphers -p 443,1443,389,3389 -oN results/sslcipher.txt -v'
    ["HTTP SVN"]='nmap --script http-svn-enum,http-svn-info -p 443 -oN results/httpsvnenum.txt -v'
    ["NetBIOS Information Disclosure"]='nmap -sU -sV -T4 --script nbstat -p137 -Pn -n -oN results/netbiosinfodis.txt -v'
    ["Oracle TNS Version"]='nmap --script oracle-tns-version -p 1521 -T4 -sV -oN results/oracletnsversion.txt -v'
    ["Oracle SID Bruteforce"]='nmap --script oracle-sid-brute -p 1521 -T4 -sV -oN results/oraclesidbrute.txt -v'
    ["NTP Service"]='nmap -sU -sV --script ntp-monlist,ntp-info -p 123 -oN results/ntpservice.txt -v'
    ["SNMP Information Disclosure"]='nmap -sV --script snmp-brute -p161 -vvv -oN results/snmpinfodis.txt -v'
    ["LDAP"]='nmap -n -sV --script ldap*,ldap-search,ldap-novell-getpass -p 389,636,3268,3269 -oN results/ldap.txt -v'
    ["HTTP"]='nmap -p 80,8080 --script http-iis-webdav-vuln,http-iis-short-name-brute,http-auth-finder,http-apache-server-status,http-traceroute,http-trace,http-vuln*,http-axis2-dir-traversal,http-cross-domain-policy --script-args http-cross-domain-policy.domain-lookup=true -oN results/http.txt -v'
    ["Portmapper"]='nmap -sSUC --script nfs-showmount -p111 -oN results/portmapper111.txt -v'
    ["MySQL"]='nmap -sV -p 3306 --script mysql-audit,mysql-databases,mysql-dump-hashes,mysql-empty-password,mysql-enum,mysql-info,mysql-query,mysql-users,mysql-variables,mysql-vuln-cve2012-2122 -oN results/mysql.txt -v'
    ...
    ["SSH"]='nmap -p22 --script ssh2-enum-algos,ssh-hostkey,ssh-auth-methods --script-args ssh_hostkey=full,ssh.user=root -oN results/ssh.txt -v'
    ["Telnet Service"]='nmap -n -sV -Pn --script telnet-brute,telnet-encryption,lu-enum,cics-info --script-args cics-info.user=test,cics-info.pass=test,cics-info.cemt='ZEMT',cics-info.trans=CICA -p 23 -oN results/telnetservice.txt -v'
    ["DNS"]='nmap -n --script default,dns-fuzz,dns-brute,dns-cache-snoop -p 53 -oN results/dnsvuln.txt -v'
    ["Pop3"]='nmap --script pop3-capabilities,pop3-ntlm-info -sV -p 110 -oN results/pop3.txt -v'
    ["NFS"]='nmap --script nfs-ls,nfs-showmount,nfs-statfs -p 2049 -oN results/nfs.txt -v'
    ["RDP Check"]='nmap --script rdp-enum-encryption,rdp-vuln-ms12-020,rdp-ntlm-info -p 3389 -T4 -oN results/rdpscript.txt -v'
    ["Apache AJP"]='nmap -sV --script ajp-auth,ajp-headers,ajp-methods,ajp-request -n -p 8009 -oN results/apacheajp.txt -v'
    ["FTP"]='nmap --script ftp-anon --script-args ftp-anon.maxlist=-1 -p 21 -oN results/ftp.txt -v'
    ["TFTP"]='nmap -n -Pn -sU -p69 -sV --script tftp-enum -oN results/tftp.txt -v'
    ["Wildcard Certificate"]='nmap --script ssl-cert -p443 -oN results/wildcardcert.txt -v'
    ["SMTP"]='nmap --script smtp-commands,smtp-open-relay,smtp-enum-users -p 25,465,587 -oN results/smtp.txt -v'
    ["IPMI"]='nmap -sU --script ipmi-brute,ipmi-cipher-zero -p 623 -oN results/ipmi.txt -v'
    ["IMAP"]='nmap --script imap-brute,imap-ntlm-info -p 143,993 -oN results/imap.txt -v'
    ["IKE"]='nmap -sU -sV --script ike-version -p 500 -oN results/ike.txt -v'
    ["AFP"]='nmap -sS -sV --script afp-showmount,afp-ls -p 548 -oN results/afp.txt -v'
    ["Broadcast DNS"]='nmap --script broadcast-dns-service-discovery -oN results/broadcastdns.txt -v'
    ["Broadcast Listener"]='nmap --script broadcast-listener -e eth0 -oN results/broadcastlistener.txt -v'
    ["Broadcast Jenkins"]='nmap --script broadcast-jenkins-discover --script-args timeout=15s -oN results/broadcastjenkins.txt -v'
    ["Broadcast UPNP"]='nmap -sV --script broadcast-upnp-info -oN results/broadcastupnp.txt -v'
    ["Gopher"]='nmap --script gopher-ls --script-args gopher-ls.maxfiles=100 -p 70 -oN results/gopher.txt -v'
    ["Kerberos"]='nmap --script krb5-enum-users --script-args krb5-enum-users.realm='test' -p 88 -oN results/kerberos.txt -v'
    ["PJL"]='nmap --script pjl-ready-message.nse --script-args 'pjl_ready_message="pwn3d!"' -oN results/pjl.txt -v'
    ["Redis"]='nmap --script redis-info,redis-brute -p 6379 -oN results/redis.txt -v'
    ["RealVNC"]='nmap --script realvnc-auth-bypass -p 5900 -oN results/realvnc.txt -v'
    ["SIP"]='nmap -sU --script sip-brute,sip-call-spoof,sip-enum-users --script-args 'sip-enum-users.padding=4,sip-enum-users.minext=1000,sip-enum-users.maxext=9999' -p 5060 -oN results/sip.txt -v'
    ["TCP"]='nmap -sC -sV -oN results/tcp.txt -v --reason'
    ["UDP"]='nmap -sC -sU -T4 -oN results/udp.txt -v --reason'
    ["All Ports"]='nmap -p- -T4 -oN results/allports.txt -v --reason'
)
